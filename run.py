...
def handle_connect():
    ...
    emit('status', {'message': 'Connected to NYL Underwriting with Nova Sonic'})
...
if __name__ == '__main__':
    ...
    print("[INFO] Access: http://127.0.0.1:8080")
    print("[INFO] Health check: http://127.0.0.1:8080/health")
    print("=" * 60)
